...
impl Plugin for DealerMenuPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(OnEnter(MenuState::Dealer), ui::show);
        app.add_systems(Update, on_update.run_if(in_state(MenuState::Dealer)));
        app.add_systems(OnExit(MenuState::Dealer), ui::hide);
    }
}
